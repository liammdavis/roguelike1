...
def cast_lightning(*args, **kwargs):
    ...
    if target:
        results.append({'consumed': True, 'target': target, 'message': Message('a lightningbolt strikes the {0} with a loud thunder! the damage is {1}'.format(target.name, damage))})
