...
def get_constants():
    ...
    #python doesn't have a way to declare variables that never change (like 'final' for java
    #and 'readonly for c#) these are called constants because the "shouldn't" change, we could alter them if we wanted
    constants = {
