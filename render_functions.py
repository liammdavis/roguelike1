...
def draw_entity(con, entity,fov_map, game_map):
    #this is how the stairs stay visible even when out of fov, it checks if the entity has the stairs component and if the map has
    #been explored. If so the entity is drawn regardless if its in fov or not
