...
class GameMap:
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size, map_width, map_height, player, entities):
        ...
        for r in range(max_rooms):
            ...
            for other_room in rooms:
                ...
                if num_rooms == 0:
                    #this is the first room, where the plater starts
                    player.x = new_x
                    player.y = new_y
                else:
                    ...
                    #flip a coin (randome number that is either 1 or 0)
                    if randint(0, 1) == 1:
    ...
    def place_entities(self, room, entities):
        ...
        #weight does not have to sum to 100
        monster_chances = {
            'orc': 80,
        ...
        item_chances = {
            'healing_potion': 35,
            'sword': 50, #from_dungeon_level([[5, 4]], self.dungeon_level),
            'shield': 50, #from_dungeon_level([[15, 8]], self.dungeon_level),
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities if entity.x == x and entity.y == y]):
                ...
                if item_choice == 'healing_potion':
                    ...
                    item = Entity(x, y, '#', libtcod.light_pink, 'Consfusion Scroll', render_order=RenderOrder.ITEM, item=item_component)
